const Footer = () => {
	return (
		<footer className='bg-shades-primary-500 shadow-2xl shadow-shades-primary-400'>
			<div className='mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8'>
				<div className='md:flex md:justify-between'>
					...
					<div className='grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 text-primary-100'>
						<div>
